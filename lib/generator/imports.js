...
function generateNestjsKeycloakTyepGraphQLImport(sourceFile) {
    sourceFile.addImportDeclaration({
        moduleSpecifier: "nestjs-keycloak-typegraphql",
        namedImports: ["Resolver"],
    });
}
exports.generateNestjsKeycloakTyepGraphQLImport = generateNestjsKeycloakTyepGraphQLImport;
